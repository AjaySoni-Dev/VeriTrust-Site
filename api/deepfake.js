...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      await releaseQuotaReservation(entitlement.decision?.reservation_id, error.code || 'DEEPFAKE_SCAN_FAILED');
      try { await failScanRecord(scanId, String(error.code || 'DEEPFAKE_SCAN_FAILED')); }
