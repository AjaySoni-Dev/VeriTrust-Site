document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelector('[data-auth-action="reset"]')?.addEventListener('click', (event) => {
    event.preventDefault();
    showMessage('Password recovery is not available yet. Contact your workspace administrator.', 'info');
  });
});
