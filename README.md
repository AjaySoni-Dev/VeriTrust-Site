...
| Developer API | Active | API-key management plus `/api/v1/deepfake`, `/api/v1/phishing`, and `/api/v1/usage` |
...
| Enterprise integrations | Coming soon | Official SDKs, webhooks, browser extension, video analysis, organization analytics, and enterprise API plans are not claimed as available |
