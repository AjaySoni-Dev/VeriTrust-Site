...
values
  ...
  ('swift', 'link', 'VeriTrust Swift', 'hf-inference', 'kmack/malicious-url-detection', true, null),
  ('sentinel', 'link', 'VeriTrust Sentinel', 'locked', 'local-rules-disabled', false, 'swift')
