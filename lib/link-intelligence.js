...
const LINK_MODELS = {
  swift: {
    ...
    hfModel: 'CrabInHoney/urlbert-tiny-v4-malicious-url-classifier',
    description: 'Fast URL threat classification',
    type: 'multi_class_url_classifier',
  ...
  sentinel: {
    ...
    hfModel: 'ilkayO/modernbert-phishing-detector',
    description: 'Robust suspicious-link and phishing analysis',
