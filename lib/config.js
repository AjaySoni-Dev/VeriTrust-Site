...
const serverConfig = {
  ...
  get gatewaySynchronousBudgetMs() {
    return getOptionalInteger('VERITRUST_GATEWAY_SYNC_BUDGET_MS', 55000, { minimum: 1000, maximum: 55000 });
  },
  get gatewayWorkerId() {
  ...
  get gatewayModelConcurrency() {
    return getOptionalInteger('VERITRUST_GATEWAY_MODEL_CONCURRENCY', 1, { minimum: 1, maximum: 8 });
  },
