...
const serverConfig = {
  ...
  get allowedOrigins() {
    return [...VERITRUST_RUNTIME_DEFAULTS.allowedOrigins];
  },
  get siteUrl() {
    return VERITRUST_RUNTIME_DEFAULTS.siteUrl;
  },
};

const allowedOrigins = [...VERITRUST_RUNTIME_DEFAULTS.allowedOrigins];
