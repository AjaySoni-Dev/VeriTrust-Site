...
async function runMailGuard(text, timeoutMs = 20000) {
...
async function runCortex(text, timeoutMs = 20000) {
...
async function runLinkModel(modelKey, normalizedUrl, ruleAnalysis, contextText = '', timeoutMs = 20000) {
